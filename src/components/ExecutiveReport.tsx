      ...
      >
        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal list-inside text-xs text-slate-300 print:text-slate-800 space-y-2.5 leading-relaxed">
            ...
            <li>
              <strong>Solución a Problema 6 — Auditoría Diaria Automatizada (Cron Jobs a las 08:00 AM) & Candados en Supabase:</strong> Tarea programada diaria (<code className="font-mono text-yellow-300 font-bold">Cron Job</code>) que ejecuta automáticamente las Consultas SQL 5, 9 y 10 para auditar el sistema cada mañana. Compara las entregas del día contra el catálogo, detecta rutas huérfanas (<code className="font-mono text-yellow-300">RT-C-03</code> y <code className="font-mono text-yellow-300">RT-D-04</code>), brechas de paradas faltantes y campos vacíos (<code className="font-mono">vehicle_id</code>), enviando un reporte diario automático por correo a logística. Respaldado por candados en Supabase (<code className="font-mono">FOREIGN KEY</code> y <code className="font-mono">NOT NULL</code>).
            </li>
          </ol>
        </div>
